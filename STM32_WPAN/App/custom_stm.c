    ...
    case HCI_VENDOR_SPECIFIC_DEBUG_EVT_CODE:
      ...
      switch(blecore_evt->ecode)
      {
        case ACI_GATT_ATTRIBUTE_MODIFIED_VSEVT_CODE:
          ...
          if(attribute_modified->Attr_Handle == (CustomContext.CustomSdHdle + CHARACTERISTIC_VALUE_ATTRIBUTE_OFFSET))
          {
        ...
        case ACI_GATT_READ_PERMIT_REQ_VSEVT_CODE :
          ...
          if(read_req->Attribute_Handle == (CustomContext.CustomSdHdle + CHARACTERISTIC_VALUE_ATTRIBUTE_OFFSET))
          {
            return_value = SVCCTL_EvtAckFlowEnable;
        ...
        case ACI_GATT_WRITE_PERMIT_REQ_VSEVT_CODE:
          ...
          if(write_perm_req->Attribute_Handle == (CustomContext.CustomSdHdle + CHARACTERISTIC_VALUE_ATTRIBUTE_OFFSET))
          {
            return_value = SVCCTL_EvtAckFlowEnable;
